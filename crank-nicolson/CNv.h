...
class cnv_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  cnv_finite_element_0();

  /// Destructor
  virtual ~cnv_finite_element_0();
...
class cnv_finite_element_1: public ufc::finite_element
{
public:

  /// Constructor
  cnv_finite_element_1();

  /// Destructor
  virtual ~cnv_finite_element_1();
...
class cnv_finite_element_2: public ufc::finite_element
{
public:

  /// Constructor
  cnv_finite_element_2();

  /// Destructor
  virtual ~cnv_finite_element_2();
...
class cnv_dofmap_0: public ufc::dofmap
{
public:
...
class cnv_dofmap_1: public ufc::dofmap
{
public:
...
class cnv_dofmap_2: public ufc::dofmap
{
public:
...
class cnv_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  cnv_cell_integral_0_otherwise();

  /// Destructor
  virtual ~cnv_cell_integral_0_otherwise();
...
class cnv_cell_integral_1_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  cnv_cell_integral_1_otherwise();

  /// Destructor
  virtual ~cnv_cell_integral_1_otherwise();
...
class cnv_form_0: public ufc::form
{
public:
...
class cnv_form_1: public ufc::form
{
public:
...
public:
  ...
  CoefficientSpace_c(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new cnv_finite_element_1()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new cnv_dofmap_1()), mesh)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_c(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new cnv_finite_element_1()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new cnv_dofmap_1()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_c(const dolfin::Restriction& restriction):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(restriction.mesh()),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new cnv_finite_element_1()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new cnv_dofmap_1()),
...
public:
  ...
  CoefficientSpace_eta(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new cnv_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new cnv_dofmap_0()), mesh)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_eta(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new cnv_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new cnv_dofmap_0()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_eta(const dolfin::Restriction& restriction):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(restriction.mesh()),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new cnv_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new cnv_dofmap_0()),
                                                                                     reference_to_no_delete_pointer(restriction))))
  {
    // Do nothing
  }
...
public:
  ...
  CoefficientSpace_f1(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new cnv_finite_element_2()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new cnv_dofmap_2()), mesh)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f1(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new cnv_finite_element_2()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new cnv_dofmap_2()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f1(const dolfin::Restriction& restriction):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(restriction.mesh()),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new cnv_finite_element_2()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new cnv_dofmap_2()),
                                                                                     reference_to_no_delete_pointer(restriction))))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 0)
  {
    ...
    _ufc_form = std::shared_ptr<const ufc::form>(new cnv_form_0());
  }
...
typedef CoefficientSpace_u1 Form_L_FunctionSpace_3;

typedef CoefficientSpace_v1 Form_L_FunctionSpace_4;

typedef CoefficientSpace_k Form_L_FunctionSpace_5;

typedef CoefficientSpace_eta Form_L_FunctionSpace_6;
...
public:
  ...
  Form_L(const dolfin::FunctionSpace& V0):
    dolfin::Form(1, 8), c(*this, 0), u(*this, 1), u1(*this, 2), v1(*this, 3), k(*this, 4), eta(*this, 5), f1(*this, 6), f2(*this, 7)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);

    _ufc_form = std::shared_ptr<const ufc::form>(new cnv_form_1());
  }

  // Constructor
  Form_L(const dolfin::FunctionSpace& V0, const dolfin::GenericFunction& c, const dolfin::GenericFunction& u, const dolfin::GenericFunction& u1, const dolfin::GenericFunction& v1, const dolfin::GenericFunction& k, const dolfin::GenericFunction& eta, const dolfin::GenericFunction& f1, const dolfin::GenericFunction& f2):
    dolfin::Form(1, 8), c(*this, 0), u(*this, 1), u1(*this, 2), v1(*this, 3), k(*this, 4), eta(*this, 5), f1(*this, 6), f2(*this, 7)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  typedef Form_L_FunctionSpace_3 CoefficientSpace_u1;
  typedef Form_L_FunctionSpace_4 CoefficientSpace_v1;
  typedef Form_L_FunctionSpace_5 CoefficientSpace_k;
  typedef Form_L_FunctionSpace_6 CoefficientSpace_eta;
