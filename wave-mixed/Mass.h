...
class mass_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  mass_finite_element_0();

  /// Destructor
  virtual ~mass_finite_element_0();
...
class mass_finite_element_1: public ufc::finite_element
{
public:

  /// Constructor
  mass_finite_element_1();

  /// Destructor
  virtual ~mass_finite_element_1();
...
class mass_finite_element_2: public ufc::finite_element
{
public:

  /// Constructor
  mass_finite_element_2();

  /// Destructor
  virtual ~mass_finite_element_2();
...
class mass_finite_element_3: public ufc::finite_element
{
public:

  /// Constructor
  mass_finite_element_3();

  /// Destructor
  virtual ~mass_finite_element_3();
...
class mass_dofmap_0: public ufc::dofmap
{
public:
...
class mass_dofmap_1: public ufc::dofmap
{
public:
...
class mass_dofmap_2: public ufc::dofmap
{
public:
...
class mass_dofmap_3: public ufc::dofmap
{
public:
...
class mass_cell_integral_0_otherwise: public ufc::cell_integral
{
public:
  ...
  /// Destructor
  virtual ~mass_cell_integral_0_otherwise();
...
class mass_form_0: public ufc::form
{
public:
...
public:
  ...
  CoefficientSpace_c(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new mass_finite_element_2()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new mass_dofmap_2()), mesh)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_c(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new mass_finite_element_2()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new mass_dofmap_2()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_c(const dolfin::Restriction& restriction):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(restriction.mesh()),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new mass_finite_element_2()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new mass_dofmap_2()),
...
public:
  ...
  Form_a_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new mass_finite_element_3()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new mass_dofmap_3()), mesh)))
  {
    // Do nothing
  }
  ...
  Form_a_FunctionSpace_0(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new mass_finite_element_3()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new mass_dofmap_3()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
  ...
  Form_a_FunctionSpace_0(const dolfin::Restriction& restriction):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(restriction.mesh()),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new mass_finite_element_3()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new mass_dofmap_3()),
                                                                                     reference_to_no_delete_pointer(restriction))))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 1), c(*this, 0)
  {
    ...
    _ufc_form = std::shared_ptr<const ufc::form>(new mass_form_0());
  }
  ...
  // Constructor
  Form_a(const dolfin::FunctionSpace& V1, const dolfin::FunctionSpace& V0, std::shared_ptr<const dolfin::GenericFunction> c):
    dolfin::Form(2, 1), c(*this, 0)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
    _function_spaces[1] = reference_to_no_delete_pointer(V1);
  ...
  // Constructor
  Form_a(std::shared_ptr<const dolfin::FunctionSpace> V1, std::shared_ptr<const dolfin::FunctionSpace> V0, const dolfin::GenericFunction& c):
    dolfin::Form(2, 1), c(*this, 0)
  {
    _function_spaces[0] = V0;
    _function_spaces[1] = V1;
