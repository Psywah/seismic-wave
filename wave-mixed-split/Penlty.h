...
class penlty_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  penlty_finite_element_0();

  /// Destructor
  virtual ~penlty_finite_element_0();
...
class penlty_finite_element_1: public ufc::finite_element
{
public:

  /// Constructor
  penlty_finite_element_1();

  /// Destructor
  virtual ~penlty_finite_element_1();
...
class penlty_dofmap_0: public ufc::dofmap
{
public:
...
class penlty_dofmap_1: public ufc::dofmap
{
public:
...
class penlty_interior_facet_integral_0_otherwise: public ufc::interior_facet_integral
{
public:

  /// Constructor
  penlty_interior_facet_integral_0_otherwise();

  /// Destructor
  virtual ~penlty_interior_facet_integral_0_otherwise();
...
class penlty_form_0: public ufc::form
{
public:
...
public:
  ...
  Form_a_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new penlty_finite_element_1()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new penlty_dofmap_1()), mesh)))
  {
    // Do nothing
  }
  ...
  Form_a_FunctionSpace_0(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new penlty_finite_element_1()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new penlty_dofmap_1()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
  ...
  Form_a_FunctionSpace_0(const dolfin::Restriction& restriction):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(restriction.mesh()),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new penlty_finite_element_1()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new penlty_dofmap_1()),
...
public:
    ...
    dolfin::Form(2, 0)
  {
    ...
    _ufc_form = std::shared_ptr<const ufc::form>(new penlty_form_0());
  }
