...
class mass3d_finite_element_0: public ufc::finite_element
{
public:

  mass3d_finite_element_0();

  ~mass3d_finite_element_0() override;
...
class mass3d_finite_element_1: public ufc::finite_element
{
public:

  mass3d_finite_element_1();

  ~mass3d_finite_element_1() override;
...
class mass3d_finite_element_2: public ufc::finite_element
{
public:

  mass3d_finite_element_2();

  ~mass3d_finite_element_2() override;
...
class mass3d_finite_element_3: public ufc::finite_element
{
public:

  mass3d_finite_element_3();

  ~mass3d_finite_element_3() override;
...
class mass3d_finite_element_4: public ufc::finite_element
{
public:

  mass3d_finite_element_4();

  ~mass3d_finite_element_4() override;
...
class mass3d_finite_element_5: public ufc::finite_element
{
public:

  mass3d_finite_element_5();

  ~mass3d_finite_element_5() override;
...
class mass3d_dofmap_0: public ufc::dofmap
{
public:

  mass3d_dofmap_0();

  ~mass3d_dofmap_0() override;
...
class mass3d_dofmap_1: public ufc::dofmap
{
public:

  mass3d_dofmap_1();

  ~mass3d_dofmap_1() override;
...
class mass3d_dofmap_2: public ufc::dofmap
{
public:

  mass3d_dofmap_2();

  ~mass3d_dofmap_2() override;
...
class mass3d_dofmap_3: public ufc::dofmap
{
public:

  mass3d_dofmap_3();

  ~mass3d_dofmap_3() override;
...
class mass3d_dofmap_4: public ufc::dofmap
{
public:

  mass3d_dofmap_4();

  ~mass3d_dofmap_4() override;
...
class mass3d_dofmap_5: public ufc::dofmap
{
public:

  mass3d_dofmap_5();

  ~mass3d_dofmap_5() override;
...
class mass3d_coordinate_mapping_1: public ufc::coordinate_mapping
{
public:

  mass3d_coordinate_mapping_1();

  ~mass3d_coordinate_mapping_1() override;
...
class mass3d_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  mass3d_cell_integral_0_otherwise();

  ~mass3d_cell_integral_0_otherwise() override;
...
class mass3d_form_0: public ufc::form
{
public:

  mass3d_form_0();

  ~mass3d_form_0() override;
...
public:
  ...
  CoefficientSpace_c(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<mass3d_finite_element_4>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<mass3d_dofmap_4>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_c(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<mass3d_finite_element_4>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<mass3d_dofmap_4>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
  ...
  Form_a_FunctionSpace_0(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<mass3d_finite_element_5>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<mass3d_dofmap_5>(), *mesh))
  {
    // Do nothing
  }
  ...
  Form_a_FunctionSpace_0(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<mass3d_finite_element_5>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<mass3d_dofmap_5>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 1), c(*this, 0)
  {
    ...
    _ufc_form = std::make_shared<const mass3d_form_0>();
  }
