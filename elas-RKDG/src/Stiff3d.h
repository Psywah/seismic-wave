...
class stiff3d_finite_element_0: public ufc::finite_element
{
public:

  stiff3d_finite_element_0();

  ~stiff3d_finite_element_0() override;
...
class stiff3d_finite_element_1: public ufc::finite_element
{
public:

  stiff3d_finite_element_1();

  ~stiff3d_finite_element_1() override;
...
class stiff3d_finite_element_2: public ufc::finite_element
{
public:

  stiff3d_finite_element_2();

  ~stiff3d_finite_element_2() override;
...
class stiff3d_finite_element_3: public ufc::finite_element
{
public:

  stiff3d_finite_element_3();

  ~stiff3d_finite_element_3() override;
...
class stiff3d_finite_element_4: public ufc::finite_element
{
public:

  stiff3d_finite_element_4();

  ~stiff3d_finite_element_4() override;
...
class stiff3d_finite_element_5: public ufc::finite_element
{
public:

  stiff3d_finite_element_5();

  ~stiff3d_finite_element_5() override;
...
class stiff3d_dofmap_0: public ufc::dofmap
{
public:

  stiff3d_dofmap_0();

  ~stiff3d_dofmap_0() override;
...
class stiff3d_dofmap_1: public ufc::dofmap
{
public:

  stiff3d_dofmap_1();

  ~stiff3d_dofmap_1() override;
...
class stiff3d_dofmap_2: public ufc::dofmap
{
public:

  stiff3d_dofmap_2();

  ~stiff3d_dofmap_2() override;
...
class stiff3d_dofmap_3: public ufc::dofmap
{
public:

  stiff3d_dofmap_3();

  ~stiff3d_dofmap_3() override;
...
class stiff3d_dofmap_4: public ufc::dofmap
{
public:

  stiff3d_dofmap_4();

  ~stiff3d_dofmap_4() override;
...
class stiff3d_dofmap_5: public ufc::dofmap
{
public:

  stiff3d_dofmap_5();

  ~stiff3d_dofmap_5() override;
...
class stiff3d_coordinate_mapping_1: public ufc::coordinate_mapping
{
public:

  stiff3d_coordinate_mapping_1();

  ~stiff3d_coordinate_mapping_1() override;
...
class stiff3d_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  stiff3d_cell_integral_0_otherwise();

  ~stiff3d_cell_integral_0_otherwise() override;
...
class stiff3d_interior_facet_integral_0_otherwise: public ufc::interior_facet_integral
{
public:

  stiff3d_interior_facet_integral_0_otherwise();

  ~stiff3d_interior_facet_integral_0_otherwise() override;
...
class stiff3d_cell_integral_1_otherwise: public ufc::cell_integral
{
public:

  stiff3d_cell_integral_1_otherwise();

  ~stiff3d_cell_integral_1_otherwise() override;
...
class stiff3d_form_0: public ufc::form
{
public:

  stiff3d_form_0();

  ~stiff3d_form_0() override;
...
class stiff3d_form_1: public ufc::form
{
public:

  stiff3d_form_1();

  ~stiff3d_form_1() override;
...
public:
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<stiff3d_finite_element_4>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<stiff3d_dofmap_4>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<stiff3d_finite_element_4>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<stiff3d_dofmap_4>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
  ...
  Form_a_FunctionSpace_0(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<stiff3d_finite_element_5>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<stiff3d_dofmap_5>(), *mesh))
  {
    // Do nothing
  }
  ...
  Form_a_FunctionSpace_0(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<stiff3d_finite_element_5>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<stiff3d_dofmap_5>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 0)
  {
    ...
    _ufc_form = std::make_shared<const stiff3d_form_0>();
  }
...
public:
    ...
    dolfin::Form(1, 1), f(*this, 0)
  {
    ...
    _ufc_form = std::make_shared<const stiff3d_form_1>();
  }
