...
public:
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<stiff2d_finite_element_5>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<stiff2d_dofmap_5>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<stiff2d_finite_element_5>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<stiff2d_dofmap_5>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
