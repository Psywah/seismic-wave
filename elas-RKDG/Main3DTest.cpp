...
int main()
{
  ...
  Point p1(0.,0.,0.), p2(DomainSize, DomainSize, DomainSize);
  BoxMesh mesh(p1,p2, nx, nx, nx);
  ...
  Mass3d::FunctionSpace W(reference_to_no_delete_pointer(mesh));
  Mass3d::CoefficientSpace_c V_coeff(reference_to_no_delete_pointer(mesh));
  ...
  // Create forms
  Mass3d::BilinearForm m(reference_to_no_delete_pointer(W),reference_to_no_delete_pointer(W));
  Stiff3d::BilinearForm a(reference_to_no_delete_pointer(W),reference_to_no_delete_pointer(W));
  Stiff3d::LinearForm L(reference_to_no_delete_pointer(W));
